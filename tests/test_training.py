...
ROOT = Path(__file__).resolve().parents[1]  # inside src/tests/


# Assumes you already ran feature engineering so the processed CSVs exist.
TRAIN_PATH = ROOT/ Path("data/processed/feature_engineered_train.csv")
EVAL_PATH = ROOT/ Path("data/processed/feature_engineered_eval.csv")
